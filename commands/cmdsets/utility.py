...
class CmdWhere(MuxCommand):
    ...
    Where allows you to see locations where players are currently on the game.
    Public locations and hangouts that are teleport-OK will be highlighted in 
    blue to make it easy to see.
